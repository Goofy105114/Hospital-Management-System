          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                className="h-9 px-3.5 rounded-xl bg-white hover:bg-slate-50 text-slate-700 text-xs font-semibold flex items-center gap-1.5 transition-colors border border-slate-200 shadow-2xs"
              >
              ...
              <Link
                ...
                className="h-9 px-3.5 rounded-xl bg-primary hover:bg-primary/90 text-white text-xs font-semibold flex items-center gap-1.5 transition-all shadow-2xs"
              >
          ...
          <div className="space-y-4">
            {finalAppointments.map((apt) => {
              ...
              return (
                <div
                  key={apt.id}
                  className="bg-white rounded-2xl p-5 shadow-2xs border border-slate-200/80 relative"
                >
                  ...
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 my-4">
                    ...
                    {apt.queueToken && (
                      <div className="p-3 rounded-xl bg-slate-50 border border-slate-200/70 shrink-0 text-center min-w-[130px]">
                      ...
                      <div className="flex items-center gap-2">
                        {apt.status === "CONFIRMED" && (
                          <button
                            ...
                            className="h-8 px-3 rounded-lg border border-slate-200 text-rose-600 hover:bg-rose-50 text-xs font-semibold transition-colors"
                          >
                            Cancel Visit
                          </button>
                        )}
                        <Link
                          href={`/patient/queue`}
                          className="h-8 px-3 rounded-lg bg-slate-100 hover:bg-slate-200 text-slate-700 text-xs font-semibold transition-colors flex items-center gap-1"
                        >
