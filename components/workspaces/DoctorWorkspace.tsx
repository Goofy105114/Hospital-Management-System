...
export const DoctorWorkspace: React.FC = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <div className="flex items-center gap-3 mb-2">
            <Badge variant="doctor" size="md">
          ...
          <p className="text-sm text-slate-500 mt-1 max-w-2xl">
            Verified physician session. Real-time patient queue calls, appointment schedules, and encounter records.
          </p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
        ...
        <Card className="p-5">
          ...
          <div className="text-xs text-slate-500 mt-1">EMR Station Online</div>
        </Card>
        ...
        <div className="lg:col-span-2 space-y-6">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              ...
              <Badge variant="doctor" size="sm">Token #{activeToken}</Badge>
            </CardHeader>
            <CardContent>
              ...
              <div className="p-4 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-600 text-xs">
                ...
                <p className="text-slate-500 leading-relaxed">
                  Patient clinical history, examination observations, vitals recording, and digital prescription generator slot.
                </p>
              </div>
            </CardContent>
          </Card>
