    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 sm:p-8 shadow-sm mb-8 flex flex-col md:flex-row md:items-center justify-between gap-6">
        ...
        <div className="flex items-center gap-3">
          <Button variant="default" size="md" className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        ...
        <Card className="p-5">
          ...
          <div className="text-2xl font-bold text-sky-600 mt-2">14 In Waiting Area</div>
