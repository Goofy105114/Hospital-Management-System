...
`DIA-01..05`, `INV-05..06`, `BIL-01..06`, `IPD-01..05`, `REP-01..05`, `AI-01..04`

### Sprint 4 — Test & Release
`SEC-02..04` plus `REL-01..08` release, integration, testing, UAT and handover work.

**Traceability rule:** `BRD Feature ID → SOW/SRS child items → Sprint → backlog work item → test/UAT coverage`. The sprint allocation does not create new BRD features, remove BRD scope, or change feature contracts.
